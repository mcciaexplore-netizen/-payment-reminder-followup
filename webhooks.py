...
def create_app(connectors=None):
    ...
    async def portal(request):
        ...
        try:
            ...
            <style>body{{font-family:system-ui;max-width:760px;margin:40px auto;padding:0 20px;color:#152331;background:#f6f8fa}}section,form{{background:white;border:1px solid #d5dce2;padding:20px;margin:16px 0;border-radius:8px}}button,input{{padding:10px;font:inherit}}a{{color:#1752a0}}</style>
